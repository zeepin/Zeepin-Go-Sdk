...
type ClientMgr struct {
	rpc       *RpcClient  //Rpc client used the rpc api of zeepin
	rest      *RestClient //Rest client used the rest api of zeepin
	ws        *WSClient   //Web socket client used the web socket api of zeepin
	defClient ZeepinClient
	qid       uint64
}
...
func (this *ClientMgr) SetDefaultClient(client ZeepinClient) {
...
func (this *ClientMgr) GetCurrentBlockHeight() (uint32, error) {
	...
	if client == nil {
		return 0, fmt.Errorf("don't have available client of zeepin")
	}
...
func (this *ClientMgr) GetCurrentBlockHash() (common.Uint256, error) {
	client := this.getClient()
	if client == nil {
		return common.UINT256_EMPTY, fmt.Errorf("don't have available client of zeepin")
	}
...
func (this *ClientMgr) GetBlockByHeight(height uint32) (*types.Block, error) {
	client := this.getClient()
	if client == nil {
		return nil, fmt.Errorf("don't have available client of zeepin")
	}
...
func (this *ClientMgr) GetVersion() (string, error) {
	client := this.getClient()
	if client == nil {
		return "", fmt.Errorf("don't have available client of zeepin")
	}
...
//WaitForGenerateBlock Wait zeepin generate block. Default wait 2 blocks.
...
func (this *ClientMgr) getClient() ZeepinClient {
